...
export const StopMarker = ({ stop, charNearby, lit }) => {
  ...
  switch (stop.type) {
      ...
      return (
        <div style={{ position: "absolute", bottom: baseY, left: stop.x - 60 }}>
          <div style={{ position: "relative", width: 120, height: 160 }}>
            <div style={{ position: "absolute", bottom: 0, left: 0, width: 120, height: 110, background: "#e8d3b8", border: "2.5px solid #1b1b1b", filter: "url(#wobble)" }}/>
            <svg width="140" height="70" viewBox="0 0 140 70" style={{ position: "absolute", bottom: 105, left: -10 }}>
              <path d="M 0 70 L 70 5 L 140 70 Z" fill="#7a4a32" stroke="#1b1b1b" strokeWidth="2.5" filter="url(#wobble)"/>
            </svg>
            <div style={{ position: "absolute", bottom: 0, left: 40, width: 40, height: 70, background: "#5a3a20", border: "2px solid #1b1b1b", filter: "url(#wobble)" }}>
              <div style={{ position: "absolute", top: 35, right: 4, width: 5, height: 5, background: "#fef3a3", border: "1px solid #1b1b1b", borderRadius: "50%" }}/>
            </div>
            <div style={{ position: "absolute", bottom: 70, left: 10, width: 22, height: 22, background: "#fef3a3", border: "2px solid #1b1b1b", filter: "url(#wobble)" }}/>
            <div style={{ position: "absolute", bottom: 70, right: 10, width: 22, height: 22, background: "#fef3a3", border: "2px solid #1b1b1b", filter: "url(#wobble)" }}/>
          </div>
      ...
      return (
        <div style={{ position: "absolute", bottom: baseY, left: stop.x - 110 }}>
          ...
          <div style={{
            ...
            transform: charNearby ? "rotate(-1.5deg) translateY(-2px)" : "rotate(0deg)",
    ...
    case "notes":
      return (
        <div style={{ position: "absolute", bottom: baseY, left: stop.x - 30 }}>
          <div style={{ width: 60, height: 90, background: "#7a4a32", border: "2.5px solid #1b1b1b", filter: "url(#wobble)", position: "relative" }}>
    ...
    case "soon":
      return (
        <>
          <svg width="240" height="120" viewBox="0 0 240 120" style={{ position: "absolute", bottom: baseY, left: stop.x - 120 }}>
    ...
    case "peak":
      return (
        <>
          <svg width="320" height="260" viewBox="0 0 320 260" style={{ position: "absolute", bottom: baseY, left: stop.x - 160 }}>
